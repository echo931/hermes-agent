...
| `XAI_STT_BASE_URL` | Override the xAI speech-to-text endpoint (default: `https://api.x.ai/v1`; the `/stt` path is appended automatically) |
...
| `XAI_STT_BASE_URL` | Override the xAI speech-to-text endpoint |
